          ...
          <div className="mt-10 col-span-full grid justify-center p-3 shadow-lg gap-8 sm:grid-cols-2 grid-cols-1">
            ...
            <div className="text-start">
              ...
              <p className="mt-6 2xl:text-2xl 2xl:font-semibold">
                ...
                Next.js. It offers a platform to explore various image works
                with a user-friendly interface. Here are some of its notable
                features.
              </p>
              <p className="mt-4 font-semibold 2xl:text-3xl">Key Features:</p>
              <section className="pl-16 font-semibold 2xl:text-3xl">
                <ul className="list-disc">
                  ...
                  <li>
                    Implements separate pages for distinct functionalities.
                  </li>
                  <li>
                  ...
                  <li>
                    Responsive design adapts UI based on screen size and
                    scrolling behavior.
                  </li>
                  <li>
